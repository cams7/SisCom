...
COMMENT ON TABLE public.cfop IS 'CFOP';
COMMENT ON COLUMN public.cfop.cod_cfop IS 'Codigo CFOP';
...
ALTER TABLE public.nfe_cab ADD CONSTRAINT nfe_cab_cod_cfop_fkey
...
ALTER TABLE public.venda_cab ADD CONSTRAINT venda_cab_cod_cfop_fkey
FOREIGN KEY (cod_cfop)
REFERENCES public.cfop (cod_cfop)
ON DELETE NO ACTION
ON UPDATE NO ACTION
